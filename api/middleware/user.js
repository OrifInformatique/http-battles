...
// import fonctions util 
const utilUpdateUser = require('../util/user/update')
...
exports.updateUser = async (req, res, next) => {
    ...
    if (req.body.savePassword !== undefined) {
    ...
    if (req.body.update.email !== undefined) {
        req.body.email = req.body.update.email
    }

    if (req.body.update.password !== undefined) {
        req.body.password = req.body.update.password
    }

    if (req.body.update.username !== undefined) {
        req.body.username = req.body.update.username
    }

    if (req.body.update.firstname !== undefined) {
        req.body.firstname = req.body.update.firstname
    }

    if (req.body.update.lastname !== undefined) {
        req.body.lastname = req.body.update.lastname
    }

    await utilUpdateUser.updateUser(req)
        .then(value => {
            req.data.push({
                name: "utilUpdateUser.updateUser",
                loc: LOC_GLOB + " " + LOC_LOC,
                value: value
            })
        })
