...
router.get('/games/findGame', auth, check.dataInit, check.checkReqDataFindGame, middleGame.getGame, middleUser.getCreatorById, middleGame.getCreateurUsername, middleGame.formatedGame, check.logInit, check.dataValidity, gameCtrl.findGame)
