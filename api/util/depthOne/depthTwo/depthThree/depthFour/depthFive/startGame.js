...
const utilGetOtherUserId = require('./depthSix/depthBottom/getOtherUserId')

// import les fonction utiles pour utilisateur
const utilUpdateXgetGame = require('./depthSix/crossRoad/updateXgetGame')

// import les fonction utiles pour testUserTurn
const utilTestUserTurn = require('./depthSix/depthBottom/testUserTurn')

const utilGetStartUserId = require('./depthSix/depthBottom/getStartUserId')

const utilGetStartGameState = require('./depthSix/depthBottom/getStartGameState')

const utilCoinFlip = require('./depthSix/depthBottom/coinFlip')

const utilInsertWord = require('./depthSix/depthBottom/insertWord')

const utilInsertBlank = require('./depthSix/depthBottom/insertBlank')

const utilCreateWord = require('./depthSix/depthBottom/createWord')

const utilSaveWord = require('./depthSix/depthBottom/saveWord')

const utilCreatePhrase = require('./depthSix/depthBottom/createPhrase')

const utilSavePhrase = require('./depthSix/depthBottom/savePhrase')
